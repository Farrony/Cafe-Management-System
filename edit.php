<?php 
		...
		$update_id=$_GET['employee_id'];
		
	$fetchQuery="SELECT * FROM employee WHERE id=$update_id";
	...
	if (isset($_POST['updatedata'])) {
		...
		$updateQuery="UPDATE employee SET name='$name',address='$address',birthdate=$birthdate,gender='$gender' WHERE id=$update_id";
...
<body>	
    ...
    padding: 10px;
    margin-bottom: 50px;
    margin-top: 40px;">Update Employee Data</h3>
