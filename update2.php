...
// data insert code 
	...
	if (isset($_POST['insertdata'])) {
		...
		$insertQuery="INSERT INTO `menu`(`id`,`name`,`price`) VALUES ('','$name','$price')";
	...
	if (isset($_POST['search_btn'])) {
		...
		$fetchQuery="SELECT * FROM menu WHERE name LIKE 
		'%$search_data'";
		$flag=1;
...
<body>
    ...
    padding: 10px;
    margin-bottom: 50px;
    margin-top: 40px;">Edit / Delete Item</h3>
	...
	<?php
			...
			<tr>
				...
				<td style="padding: 10px"><a href="edit2.php?menu_id=<?php echo $row['id'];?>" class="glyphicon glyphicon-pencil">&nbsp;&nbsp;Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="delete2.php?menu_id=<?php echo $row['id'];?>" class="glyphicon glyphicon-remove">&nbsp;&nbsp;Delete</a></td>
