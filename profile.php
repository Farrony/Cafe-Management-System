	...
	<!-- area -->
		<div class="area_main">
			<div class="container-fluid">
				<div class="row">
					<!-- left -->
					<div style="border-right:1px solid #50a3d7" class="col-md-2">
					...
					<div class="col-md-10">
						<div class="row">
							<div class="col-md-12">
								<div class="pr">
									<h2>Welcome, <?php echo isset($_SESSION['login_auth'])? $_SESSION['login_auth']:$_COOKIE['login_auth_cookie']; ?></h2>
									<img class="img-thumbnail" src="image/av.jpg">
									<h3 style="margin-left: 70px"><?php echo isset($_SESSION['login_auth'])? $_SESSION['login_auth']:$_COOKIE['login_auth_cookie']; ?></h3>
								</div>
							</div>
						</div>
					</div>
